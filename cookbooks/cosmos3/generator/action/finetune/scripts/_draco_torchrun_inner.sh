...
echo "IMAGINAIRE_OUTPUT_ROOT=${IMAGINAIRE_OUTPUT_ROOT:-unset}"
...
export IMAGINAIRE_OUTPUT_ROOT="${IMAGINAIRE_OUTPUT_ROOT:?launcher must set the canonical output root}"
...
if [[ "${COSMOS_OPENH_PATH_LAYOUT:-}" == "draco_internal" ]]; then
